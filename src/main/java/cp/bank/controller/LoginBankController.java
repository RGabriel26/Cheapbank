...
//				this.loggedID = userID;
				application.CheapBankApplication.loggedID = userID;
				System.out.println("valoarea variabilei loggedid din application packege: " + application.CheapBankApplication.loggedID);
				//error
